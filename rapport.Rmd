...
library("ggplot2")
creat_fig <- function(filename, ylabel){
...
creat_fig(paste0("Power_20_", n, ".csv"), ylabel = 'Power')
```
```{r figurePower40, fig.cap="Power for 40-element samples", echo=FALSE, eval=TRUE}
creat_fig(paste0("Power_40_", n, ".csv"), ylabel = 'Power')
```
...
creat_fig(paste0("TypeI_error_20_", n, ".csv"), ylabel = 'Type I error')
```

```{r figureT140, fig.cap="Type I error for 40-element samples", echo=FALSE, eval=TRUE}
creat_fig(paste0("TypeI_error_40_", n, ".csv"), ylabel = 'Type I error')
```
