...
```{r figurePower20, fig.cap="T", echo=FALSE, eval=FALSE}
library("ggplot2")
...
creat_fig("Power_20_20.csv")
```
```{r figurePower40, fig.cap="Test", echo=FALSE, eval=FALSE}
creat_fig("Power_40_2.csv")
```
...
```{r figureT120, fig.cap="Test", echo=FALSE, eval=FALSE}
creat_fig("TypeI_error_20_2.csv")
```

```{r figureT140, fig.cap="Test", echo=FALSE, eval=FALSE}
creat_fig("TypeI_error_40_2.csv")
```
...
```{r simulations, eval=TRUE, results='hide'}
# Simulations
